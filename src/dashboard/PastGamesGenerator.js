...
export default function PastGamesGenerator(props) {
  ...
  const [apiUrl, setApiUrl] = React.useState(
    "http://35.153.97.187:8080/schedule/GamesByDate/2021-01-01"
  );
  ...
  function handleClick() {
    ...
    if (
      !(
        apiUrl ===
        "http://35.153.97.187:8080/schedule/GamesByDate/" +
          year +
          "-" +
          month +
          "-" +
  ...
  return (
    <div className={classes.container}>
      <i className={classes.instructionField}>
        Games present from February 26th, 2021 and onwards.
      </i>
      <DataGrid
        autoHeight={true}
